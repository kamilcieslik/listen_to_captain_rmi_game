            ...
            try {
                ...
                if (server.isExistPlayerNickname(Main.nickname))
                    ...
                    try {
                        ...
                        Main.player = new PlayerImpl(Main.nickname, "Laboratorium paliw rakietowych", Main.captainNickname,
                                mainController, server);
                        Main.server = Main.player.getServer();
                        Parent parent = loader.getRoot();
                        Stage primaryStage = new Stage();
                        Main.setMainStage(primaryStage);
                        primaryStage.setTitle("Listen To Your Captain - ver. Client no. 2");
