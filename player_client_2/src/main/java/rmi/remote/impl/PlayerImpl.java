...
public class PlayerImpl extends UnicastRemoteObject implements Player, Serializable {
    ...
    public void getCommand(String command) {
        playerMainController.getPlayerBeanType_2().setStringPropertyCaptainCommand(command);
    }
    ...
    public void updateNumberOfPlayers(int numberOfCaptainPlayers) {
        Platform.runLater(()-> playerMainController.getPlayerBeanType_2().setIntegerPropertyNumberOfPlayers(numberOfCaptainPlayers));
    }

    @Override
    public void addPoints(Integer numberOfPoints) {
        Platform.runLater(()-> playerMainController.getPlayerBeanType_2()
                .setIntegerPropertyNumberOfPoints(playerMainController.getPlayerBeanType_2()
